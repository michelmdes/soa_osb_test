package com.opah.apihoteis.config;
...
/**
 * Classe de configuracao do Swagger, gerador de documentacao REST
...
public class SwaggerConfig {
	...
	public Docket detalheApi() {
		...
		.select()
		.apis(RequestHandlerSelectors.basePackage("com.opah.apihoteis.resources"))
	...
	private ApiInfoBuilder informacoesApi() {
		...
		apiInfoBuilder.title("API Hoteis");
		apiInfoBuilder.description("API com recursos utilitarios referente a Hoteis (Teste OPAH)");
		apiInfoBuilder.version("0.0.1");
		// apiInfoBuilder.termsOfServiceUrl("Termo de uso: .");
		apiInfoBuilder.license("Licença - Michel Mendes");
